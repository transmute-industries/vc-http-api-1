const baseUrl = 'https://vc.transmute.world';

module.exports = {
  name: 'Transmute Prototype',
  issueCredentialConfiguration: [
    {
      id: 'did:key:z6MkjRagNiMu91DduvCvgEsqLZDVzrJzFrwahc4tXLt9DoHd',
      endpoint: `${baseUrl}/next/credentials/issue`,
  ...
  verifyCredentialConfiguration: {
    endpoint: `${baseUrl}/next/credentials/verify`,
  ...
  verifyPresentationConfiguration: {
    endpoint: `${baseUrl}/next/presentations/verify`,
    didMethodsSupported: ['did:key:'],
    linkedDataProofSuitesSupported: [
      'Ed25519Signature2018',
      'BbsBlsSignature2020',
